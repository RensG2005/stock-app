  ...
  const testimonials: Testimonial[] = [
    {
      ...
      testimonial: "Our core values are at the heart of all that we do. They are integrated into our daily work lives and help us to remember our customers always comes first, the last thank you should always comes from us.",
      name: "Anna Smith",
    ...
    <Layout title="Homepage">
      <section className="max-w-screen min-h-[100vh] xl:min-h-[80vh] flex items-center justify-center">
        <div className="flex items-center justify-center -translate-y-12 md:-translate-y-12 w-10/12 md:8/12 lg:6/12 mx-auto">
          <div className='flex flex-col items-center text-center mt-24 md:mt-12 lg:mt-0'>
            <h1 className=" text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[6rem] 2xl:text-[7rem] leading-none break-words w-9/12 font-bold">THE BEST STOCK APP IN THE WORLD</h1>
            <h3 className="mt-5 font-medium text-sm md:text-lg xl:text-xl w-6/12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit dolore veritatis doloremque ducimus aliquid accusamus minus</h3>
            <button>
              <a href="/auth/signin" className="mt-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                Start Investing now
              </a>
            </button>
          </div>
      ...
      <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40">
        <CarouselProvider naturalSlideWidth={100} naturalSlideHeight={100} isIntrinsicHeight totalSlides={2}>
          ...
          <Slider>
            {testimonials.map((testimonial, index) => <HomepageSliderSlide key={index} testimonial={testimonial} />)}
          </Slider>
