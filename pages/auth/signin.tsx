...
export default function SignIn({ providers }) {
  ...
  async function submit(id, callbackUrl = "/profile") {
  ...
  useEffect(() => {
    if (error) {
      if (typeof error === "string") {
        toastId.current = toast(errors[error] || errors.default, { type: "error", progressStyle: { height: "1px" } });
      }
    }
  }, [error])
    ...
    <Layout title="Sign in" noFooter>
      <div className="w-full">
        <div className="flex flex-col items-center justify-center">
          <div className="bg-white z-20 shadow rounded lg:w-1/2  md:w-1/2 w-full p-10 md:mt-16">
            ...
            <button onClick={() => submit(providers.google.id)} aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
            ...
            <button onClick={() => submit(providers.github.id)} aria-label="Continue with github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
