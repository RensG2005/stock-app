    ...
    if (!props.textarea) {
        ...
        return (
            <div className="relative">
                ...
                <textarea value={props.value} {...props} name={props.name} className="flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent mt-2" id={props.id}></textarea>
            </div>
        )
    }
}
